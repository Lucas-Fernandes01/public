            ...
            <div class="login__area">
               <form action="login.php" method="post" class="login__form">
                  <div class="login__content grid">
                     ...
                     <div class="login__box">
                        <input type="password" id="senha" name="senha" required placeholder=" " class="login__input">
            ...
            <div class="login__area">
               <form action="cadastro.php" method="post" class="login__form">
                  <div class="login__content grid">
                     ...
                     <div class="login__box">
                        <input type="password" id="senha" name="senha" placeholder=" " class="login__input">
                        <label for="senha" class="login__label">Senha</label>
                     ...
                     <div class="login__group grid">
                     <div class="login__box">
   <input type="text" id="bairro" name="bairro" required placeholder=" " class="login__input">
   <label for="bairro" class="login__label">Bairro</label>
   <i class="ri-map-pin-2-fill login__icon"></i>

</div>

<div class="login__box">
   <input type="text" id="endereco" name="endereco" required placeholder=" " class="login__input">
   <label for="endereco" class="login__label">Endereço</label>
   <i class="ri-home-4-fill login__icon"></i></div>
</div>

<div class="login__group grid">
<div class="login__box">
   <input type="text" id="numero" name="numero" required placeholder=" " class="login__input">
   <label for="numero" class="login__label">Número</label>
   <i class="ri-numbers-line login__icon"></i>
</div>

<div class="login__box">
   <input type="text" id="referencia" name="referencia" placeholder=" " class="login__input">
   <label for="referencia" class="login__label">Complemento</label>
   <i class="ri-map-pin-line login__icon"></i></div>
</div>
